###########################################################################
## Makefile generated for component 'hooke_jeeves'. 
## 
## Makefile     : hooke_jeeves_rtw.mk
## Generated on : Tue Nov 30 09:11:48 2021
## Final product: ./hooke_jeeves.a
...
PRODUCT_NAME              = hooke_jeeves
MAKEFILE                  = hooke_jeeves_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2020b.app
MATLAB_BIN                = /Applications/MATLAB_R2020b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/nitinongole/Documents/Stanford/Fall\ 2021/AA\ 228/Final\ Project/1D\ MPC\ +\ Policy\ Search/codegen/lib/hooke_jeeves
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=hooke_jeeves
...
SRCS = $(START_DIR)/hooke_jeeves_data.c $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c $(START_DIR)/hooke_jeeves_initialize.c $(START_DIR)/hooke_jeeves_terminate.c $(START_DIR)/hooke_jeeves.c $(START_DIR)/sim_rocket.c
...
OBJS = hooke_jeeves_data.o rt_nonfinite.o rtGetNaN.o rtGetInf.o hooke_jeeves_initialize.o hooke_jeeves_terminate.o hooke_jeeves.o sim_rocket.o
...
hooke_jeeves_data.o : $(START_DIR)/hooke_jeeves_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
hooke_jeeves_initialize.o : $(START_DIR)/hooke_jeeves_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


hooke_jeeves_terminate.o : $(START_DIR)/hooke_jeeves_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


hooke_jeeves.o : $(START_DIR)/hooke_jeeves.c
	$(CC) $(CFLAGS) -o "$@" "$<"
